...
!["Pasos para crear un proyecto con control de versiones desde RStudio si ya existe el repositorio en GitHub"](img/git_githubfirst_new_project.png)
...
!["Agregar (add) un archivo a la Staged area y luego iniciar un Commit desde RStudio"](img/git_git_staged.png)
...
!["Realizar un Commit desde RStudio"](img/git_commit_rstudio.png)
...
!["Realizar un Push desde RStudio"](img/git_push_rstudio.png)
